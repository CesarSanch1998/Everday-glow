...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
  ...
  <section id="intro" class="home-slide text-light">
    <ul id="valera-slippry">
      <li>
        <div>
          <img src="img/slides/1.jpg" alt="Bienvenido a  Everyday glow<br /><a href='#nosotros' class='btn btn-skin btn-slide'>leer mas </a>">
        </div>
      </li>
      <li>
        <div><img src="img/slides/2.jpg" alt="Entra al mundo fitness con nosotros <br /><a href='#service' class='btn btn-skin btn-slide'>Servicios</a>"></div>
      </li>
      <li>
        <div><img src="img/slides/3.jpg" alt="Preparado Para Cambiar tu salud <span class='red'>♥</span>:) <br /><a href='#Cambios' class='btn btn-skin btn-slide'>Cambios Fisicos</a>"></div>
      </li>
    </ul>
  </section>
  <!-- /Section: inicio slider -->
        ...
        <div class="col-lg-8 col-lg-offset-2">
          <div class="wow flipInY" data-wow-offset="0" data-wow-delay="0.4s">
            <div class="section-heading text-center">
              ...
              <p>Gracias a ellos miles de personas entrenan a diario y han asentado en sus hábitos de vida el ejercicio y cuidarse tanto por fuera como por dentro.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-6 col-sm-3 col-md-3">
            <div class="team-wrapper-big wow bounceInUp" data-wow-delay="0.5s">
              <div class="team-wrapper-overlay">
                <h5>Tanya Doe</h5>
                <p>entrenamientos enfocados a distintas partes del cuerpo: glúteos, abdomen, tren superior</p>
                <div class="social-icons">
                  <ul class="team-social">
                  </ul>
                </div>
          ...
          <div class="col-xs-6 col-sm-3 col-md-3">
            <div class="team-wrapper-big wow bounceInUp" data-wow-delay="0.8s">
              <div class="team-wrapper-overlay">
                <h5>Heck Steven</h5>
                <p>Más de 21.000 personas lo convierten en uno de los entrenadores más famosos de nuestro país. </p>
                <div class="social-icons">
                  <ul class="team-social">
          ...
          <div class="col-xs-6 col-sm-3 col-md-3">
            <div class="team-wrapper-big wow bounceInUp" data-wow-delay="1s">
              <div class="team-wrapper-overlay">
                <h5>Adrian Dawn</h5>
                <p>entrenador dedicado mas de 1000 estudiantes.</p>
                <div class="social-icons">
                  <ul class="team-social">
        ...
        <div class="col-lg-8 col-lg-offset-2">
          <div class="wow flipInY" data-wow-offset="0" data-wow-delay="0.4s">
            <div class="section-heading text-center">
              ...
              <div class="divider-header"></div>
              <p>Encuentra lo que necesitas con Nosotros, estamos llenos de Actividades para mantener Activo en el mundo Fitness</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="wow fadeInLeft" data-wow-delay="0.2s">
              <div class="service-box">
                ...
                <div class="service-desc">
                  <h5>Yoga</h5>
                  <p>
                    El yoga es una disciplina tradicional espiritual, física y mental originada en la India.
                  </p>
                  <a href="https://es.wikipedia.org/wiki/Yoga" class="btn btn-skin">Leer mas</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="service-box">
                ...
                <div class="service-desc">
                  <h5>CrossFit</h5>
                  <p>
                    El CrossFit es un sistema de acondicionamiento físico que se basa en ejercicios que varían de forma constante.
                  </p>
                  <a href="http://crossfitsingularbox.com/about-us/que-es-crossfit/" class="btn btn-skin">Leer mas</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="service-box">
                ...
                <div class="service-desc">
                  <h5>FitCombat</h5>
                  <p>
                    el fit combat te ayuda a ejercer movimientos dinámicos y novedosos en tus hábitos de entrenamiento.
                  </p>
                  <a href="https://mejorconsalud.as.com/que-es-el-fit-combat/" class="btn btn-skin">Leer mas</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="wow fadeInRight" data-wow-delay="0.2s">
              <div class="service-box">
                ...
                <div class="service-desc">
                  <h5>Zumba</h5>
                  <p>
                    enfocada por una parte a mantener un cuerpo saludable y por otra a desarrollar, fortalecer y dar flexibilidad al cuerpo mediante movimientos de baile
                  </p>
                  <a href="https://es.wikipedia.org/wiki/Zumba" class="btn btn-skin">Leer mas</a>
                </div>
              </div>
            </div>
          </div>
...
<ul class="contact-list">
  <li><a>Ubicacion: Maracaibo/Edo Zulia/Venezuela</a></li>
  <li><a>Correo: EverydayGlow@gmail.com</a></li>
</ul>
      ...
      <div class="row">
        <div class="col-md-6 col-md-offset-3">
          ...
          <div class="text-center">
            ...
            <p>&copy; Everyday Glow. All Rights Reserved</p>
            <div class="credits">
